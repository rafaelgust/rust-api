use axum::{
    body::Body, extract::{Json, Request}, http::{self, Response, StatusCode}, middleware::Next, response::IntoResponse
};
...
use crate::utils::{args::{commands::UserCommand, sub_commands::user_commands::{Auth, UserSubcommand}}, ops::user_ops::{self, UserResult}};
...
pub async fn sign_out(req: Request) -> Result<StatusCode, AuthError> {
